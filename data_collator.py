"""
Custom Data Collator for Qwen ChatML Instruction Tuning
Chỉ tính loss trên assistant response, mask out system và user messages
"""
            ...
            if response_token_ids_start_idx is None:
                ...
                if len(end_positions) > 0:
                        if end_pos > response_token_ids_start_idx:
                            ...
                            # Mask everything after end token
